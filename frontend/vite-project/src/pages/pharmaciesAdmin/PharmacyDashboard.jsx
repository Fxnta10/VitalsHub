    ...
    return (
      <div className="min-vh-100 d-flex align-items-center justify-content-center" style={{ background: "#f6f8fb" }}>
        <div className="text-center">
          ...
          <p className="text-secondary fw-medium">Loading pharmacy data...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container py-5">
        <div className="d-flex flex-wrap justify-content-between align-items-center mb-4">
          <div className="mb-3 mb-md-0">
            <h2 className="fw-bold mb-2" style={{ color: "#2d3748" }}>
              Welcome, {pharmacyUser?.name}
            </h2>
            <p className="text-secondary mb-0" style={{ fontSize: "1.1rem" }}>
              Manage your pharmacy's medicines and inventory
            </p>
          </div>
          <button
        ...
        {medicines.length === 0 ? (
          <div className="text-center py-5 mt-4">
            ...
            <h4 className="fw-bold mb-2" style={{ color: "#2d3748" }}>No medicines in inventory</h4>
                ...
                >
                  ...
                  <div className="mb-4">
                    <div className="row g-3">
                      <div className="col-6">
                        <p className="text-secondary small mb-1">Manufacturer</p>
                        <p className="fw-medium mb-0">{medicine.manufacturer}</p>
                      </div>
                      <div className="col-6">
                        <p className="text-secondary small mb-1">Batch Number</p>
                      ...
                      <div className="col-6">
                        <p className="text-secondary small mb-1">Stock</p>
                        <p className="fw-medium mb-0">{medicine.stock} units</p>
                      </div>
                    </div>
                  </div>
